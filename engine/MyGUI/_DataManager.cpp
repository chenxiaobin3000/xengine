...
GLESDataManager::GLESDataManager() : mIsInitialise(false) {

}

void GLESDataManager::initialise() {
...
IDataStream* GLESDataManager::getData(const std::string& _name) {
...
void GLESDataManager::freeData(IDataStream* _data) {
	delete _data;
}

bool GLESDataManager::isDataExist(const std::string& _name) {
	const VectorString& files = getDataListNames(_name);
	return !files.empty();
}

const VectorString& GLESDataManager::getDataListNames(const std::string& _pattern) {
...
const std::string& GLESDataManager::getDataPath(const std::string& _name) {
...
void GLESDataManager::addResourceLocation(const std::string& _name, bool _recursive) {
	ArhivInfo info;
